...
def streamlit_config():  #config the stramlit page layout and apperance
...
class resume_analyzer:  #contain funcs for summerize atrength,weak,suggest,job title, based on resume
